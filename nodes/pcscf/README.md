...
**Rol:** Proxy SIP de entrada del UE. REGISTER/401/200, Rx, SUBSCRIBE/NOTIFY. NODO MAS CARGADO.
...
> Código del nodo: agregar `pcscf.py` en esta carpeta al arrancar la Fase 3.
