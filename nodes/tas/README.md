...
**Rol:** App server. Recibe third-party REGISTER, descarga datos (Sh), reporta UEs registrados al final.
...
> Código del nodo: agregar `tas.py` en esta carpeta al arrancar la Fase 3.
