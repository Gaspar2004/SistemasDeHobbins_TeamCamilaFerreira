...
**Rol:** Serving CSCF. Registro, 401/200, third-party REGISTER al TAS. Emite {message:fin}. NODO MAS CARGADO.
...
> Código del nodo: agregar `scscf.py` en esta carpeta al arrancar la Fase 3.
