# Nodo: VoLTE UE 1   (R7 / E8)

**Operado por:** _________________  (poné tu apellido también en `config/nodes.json`)

**Rol:** Equipo de usuario 1. Origina Attach y REGISTER/SUBSCRIBE. Extremo del flujo.
...
> Código del nodo: agregar `volte_ue_1.py` en esta carpeta al arrancar la Fase 3.
